...
int O3DPLY::open(const string &File_name)
{
...
void O3DPLY::get_token(istringstream &Line_stream1,string &Token1)
{
...
bool O3DPLY::get_new_line(ifstream &File,istringstream &Line_stream)
{
  string Line;
...
void O3DPLY::read(vector<_vertex3f> &Vertices,vector<_vertex3i> &Triangles)
{
  string Token;
