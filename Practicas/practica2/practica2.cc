...
int act1, act2, act3, act4, act5, act6 = 0;
...
void draw_objects()
{
    ...
    if(poligono == 1){
        ...
        switch(caso){
            ...
            case 3: miesfera.draw_fill();break;
...
void normal_keys(unsigned char Tecla1,int x,int y)
{
    ...
    switch (toupper(Tecla1)) {
        ...
        case 'A': caso = 7;draw_objects();poligono = 3;leido=true;break;
        case '1': caso = 8;draw_objects();poligono = 4; if(act1 == 0){micilindro.revolucion(divisiones); act1=1;};break;
        case '2': caso = 9;draw_objects();poligono = 5;if(act2 == 0){micono.revolucion(divisiones); act2=1;};break;
        case '3': caso = 10;draw_objects();poligono = 6;if(act3 == 0){mitubo.revolucion(divisiones); act3=1;};break;
        case '4': caso = 11;draw_objects();poligono = 7;if(act4 == 0){mivaso.revolucion(divisiones); act4=1;};break;
        case '5': caso = 12;draw_objects();poligono = 8;if(act5 == 0){mivaso_inverso.revolucion(divisiones); act5=1;};break;
        case '6': caso = 13;draw_objects();poligono = 9;if(act6 == 0){miesfera.revolucion(divisiones); act6=1;};break;
    }
}
